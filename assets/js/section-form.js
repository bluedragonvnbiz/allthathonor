...
class SectionFormHandler {
    ...
    collectFormData(form) {
        ...
        const sectionPage = urlParams.get('section_page') || 'main';
        ...
        formData.append('section_page', sectionPage);
    ...
    async loadEditForm(button) {
        ...
        const blockType = card.dataset.block;
        
        if (!sectionKey || !blockType) {
            console.error('Missing section or block data');
            return;
        }
...
if (!window.sectionFormHandler) {
    document.addEventListener('DOMContentLoaded', () => {
        window.sectionFormHandler = new SectionFormHandler();
    });
}
